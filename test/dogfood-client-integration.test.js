...
test('dogfood: MCP tools/list returns 15 model-visible tools', () => {
  ...
  assert.equal(result.tools.length, 15, 'Must have 15 model-visible MCP tools');
  ...
  assert.deepEqual(names, [
    'huqan.advocate', 'huqan.agent', 'huqan.ask', 'huqan.compare', 'huqan.dream', 'huqan.ingest_execute',
