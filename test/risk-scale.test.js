...
test('every gate the MCP adapter and the external action guard name has a declared scale', () => {
  ...
  for (const file of ['lib/mcp-gate-adapter-action-gates.js', 'lib/mcp-gate-adapter-data-gates.js', 'lib/external-action-guard-gate-phase.js', 'lib/external-action-egress-gates.js']) {
