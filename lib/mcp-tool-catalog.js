...
const TOOL_SCHEMAS = [
  {
    ...
    description: 'Search the web with an explicitly selected Brave, Firecrawl or Tavily provider. Returns unverified external sources for the calling agent to cite. Does not learn or write canonical memory.',
