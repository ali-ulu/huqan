...
const { isApiAuthDisabled } = require('../../requestGuards');
...
function createRuntimeStatusHandlers({ kernel, pkg, kernelVersion, agentVersion, agentRuntimeMode, phases, observabilityReadiness } = {}) {
  ...
  function getHealthData() {
    ...
    return {
      ...
      // The dashboard reads this to decide whether to ask for an API key at
      // all. /health is public, so this reports the mode only — never a key.
      apiAuthRequired: !isApiAuthDisabled(),
