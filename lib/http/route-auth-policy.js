...
const PUBLIC_ROUTES = Object.freeze([
  ...
  Object.freeze({
    id: 'pr-guardian-ui',
    match: Object.freeze({ pathname: '/pr-guardian' }),
    methods: Object.freeze(['GET']),
    why: 'Static Review Console shell; workspace and approval data remain authenticated.',
  }),
  Object.freeze({
...
const AUTHENTICATED_ROUTES = Object.freeze([
  ...
  Object.freeze({ id: 'observability-v1', match: Object.freeze({ prefix: '/api/v1/observability' }) }),
  Object.freeze({ id: 'pr-guardian-reviews', match: Object.freeze({ pathname: '/api/v2/pr-guardian/reviews' }) }),
  Object.freeze({ id: 'pr-guardian-dry-run', match: Object.freeze({ pathname: '/api/v2/pr-guardian/dry-run' }) }),
  Object.freeze({ id: 'pr-guardian-review-actions', match: Object.freeze({ prefix: '/api/v2/pr-guardian/reviews/' }) }),
]);
