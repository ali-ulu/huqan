...
function normalizePullRequestSnapshot(input = {}, options = {}) {
  ...
  const snapshot = {
    ...
    // Whether the file list is known to be incomplete (#1308). Part of the
    // snapshot because the policy has to be able to refuse to call an
    // unexamined PR clean.
    filesTruncated: input.filesTruncated === true,
