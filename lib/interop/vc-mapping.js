...
// Points at the artifact published in this repo's canonical surface
// (specs/huqan-trust-protocol/0.2/schemas/), the same base the receipt schema
//  use. The previous value named a URL nothing published, so a JSON-LD
// processor could not dereference the terms this envelope relies on.
const HUQAN_CONTEXT_V1 = 'https://huqan.dev/specs/huqan-trust-protocol/0.2/contexts/trust-receipt-credential-context.json';
