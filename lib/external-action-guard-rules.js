...
const EXTERNAL_ACTION_REASONS = Object.freeze({
  ...
  IMPACT_BUDGET_REVIEW: 'external_action_impact_budget_review_required',
  IMPACT_BUDGET_QUORUM: 'external_action_impact_budget_quorum_required',
  IMPACT_BUDGET_BLOCK: 'external_action_impact_budget_blocked',
  IMPACT_BUDGET_DEGRADED: 'external_action_impact_budget_degraded_review',
});
