...
test('npm package dry-run preserves published receipt surface and excludes owner internals', () => {
  ...
  assert.equal(packedFiles.has('lib/external-client-mutation-receipt-owner.js'), false);
