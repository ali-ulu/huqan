...
async function decideIngestApproval(deps) {
  ...
  if (decision !== 'rejected') {
    return executeApprovedIngest({ ...deps, approval, oversightCase, decisionReason: reason, oversightDecision, identityEvaluation: oversightPreparation.identityEvaluation });
  }
