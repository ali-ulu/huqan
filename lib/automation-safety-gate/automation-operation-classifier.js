...
// are one long ordered if-chain where earlier checks intentionally establish
// the precedence for overlapping safety families. Every branch shares local
// context computed at the top (opType, opText, explicitApproval,
// approvedMergePath, secretDetected). Splitting it into smaller functions
// without re-verifying that ordering rule-by-rule risks silently changing
// which check wins for a given input. The surrounding constants, normalizers,
// summarizer, decision and evaluate layers remain split out.
