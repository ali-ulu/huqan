...
const NOT_YET_WIRED = Object.freeze({
  ...
  // Notification delivery intentionally remains an explicit caller boundary: the
  // adapter is shipped and tested, but server.js does not contact third-party
  // endpoints without configured operator wiring (#1133).
  'lib/observability/notification-adapter.js': 'secure webhook adapter is library-only until explicit notification wiring',
