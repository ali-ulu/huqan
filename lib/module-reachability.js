...
const NOT_YET_WIRED = Object.freeze({
  // --- V5 ------------------------------------------------------------------
  // ADR-010 records V5_IMPLEMENTATION_ENTRY: FAIL. A successor audit must
  // explicitly replace that decision before these modules become reachable.
  'lib/v5/cryptographic-profile-contract.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/cryptographic-verification-adapter.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/public-trust-receipt.js': 'V5 D3 public receipt exchange library; no production transport caller',
  'lib/v5/runtime-reader.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/runtime-writer.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/structural-signing-helper.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/trusted-key-resolver.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'lib/v5/verification-core.js': 'V5 library implementation; ADR-010 entry decision is FAIL',
  'schemas/v5/agent-identity-conformance.js': 'V5 schema implementation; ADR-010 entry decision is FAIL',
  'schemas/v5/agent-identity-coverage.js': 'V5 schema implementation; ADR-010 entry decision is FAIL',
  'schemas/v5/agent-identity-readiness.js': 'V5 schema implementation; ADR-010 entry decision is FAIL',
  'schemas/v5/agent-identity-validator.js': 'V5 schema implementation; ADR-010 entry decision is FAIL',
  'schemas/v5/shared-trust-package-validator.js': 'V5 schema implementation; ADR-010 entry decision is FAIL',
