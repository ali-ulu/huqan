...
const NOT_YET_WIRED = Object.freeze({
  ...
  'lib/github-app-streaming-auth.js': 'V5-C8 token helper; production dispatch remains deferred with #279 hosted/public boundary',
  'lib/github-app-streaming-trust-handler.js': 'V5-C8 raw-webhook composition; production dispatch remains deferred with #279 hosted/public boundary',
  'lib/github-app-streaming-trust.js': 'V5-C8 bounded Streaming Trust loop; production dispatch remains deferred with #279 hosted/public boundary',
  'lib/github-app-streaming-trust-store.js': 'V5-C8 durable writeback reservation store; production dispatch remains deferred with #279 hosted/public boundary',
