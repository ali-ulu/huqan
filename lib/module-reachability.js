...
const NOT_YET_WIRED = Object.freeze({
  ...
  // dryrun-runner.js/finding-schema.js/safety-decision.js graduated off this
  // list when plugins/self-healer-audit.js wired a real finding source
  // (lib/module-reachability.js's own unclassified-module list) into the
  // dry-run pipeline -- audit-runner.js and finding-classifier.js are not
  // on that require path and remain genuinely unreached.
