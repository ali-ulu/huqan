...
const STANDALONE_FILES = Object.freeze([
  ...
  'egitim.js', // #363: deprecation shim → scripts/knowledge-graph-demo.js (ships nothing, refuses to run)
  // #1792: spawned by lib/external-action-gate-install.js to load an installed
