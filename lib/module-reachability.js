...
const NOT_YET_WIRED = Object.freeze({
  ...
  'lib/github-app-beta-auth.js': 'V5-C7 GitHub App beta library under live-proof gate; no production caller yet',
  'lib/github-app-beta-store.js': 'V5-C7 GitHub App beta library under live-proof gate; no production caller yet',
  'lib/github-app-beta-handler.js': 'V5-C7 GitHub App beta library under live-proof gate; no production caller yet',
