...
const NOT_YET_WIRED = Object.freeze({
  ...
  // --- V4-B3A bounded receipt source seam ---------------------------------
  'lib/audit-bounded-read.js': 'V4-B3A bounded audit source seam; intentionally unwired until separately authorized B3 user-flow wiring',
  'lib/json-utf8-size.js': 'V4-B3A helper for the unwired bounded receipt-export seam; no production caller until B3 wiring',
