...
const NOT_YET_WIRED = Object.freeze({
  ...
  // --- Gate A ----------------------------------------------------------------
  'lib/http/crash-recovery-inventory.js': 'Gate A item 7 inventory; static 10-point table, exercised via gateA-crash-recovery.test.js, no runtime caller (checkpoint)',
  'lib/http/request-limits.js': 'Gate A item 3 limiter shim; canonical impl is server-timeouts.js to keep server.js FANOUT 52, re-export only',
});
