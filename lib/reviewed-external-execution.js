...
function prepareReviewedExternalExecution(record, options = {}) {
  ...
  if (record.status !== 'executing' || record.decision !== 'review') {
    return failure('REVIEWED_EXECUTION_STATUS_INVALID', 'approval must be claimed and executing with review decision');
  }
