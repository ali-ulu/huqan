...
async function simulateSourceCandidate(input = {}) {
  ...
  if (!candidate) {
    return { ok: true, version: SOURCE_DOGFOOD_VERSION, targetPath: dependencyGraph.targetPath, candidate: null, applied: false, patchIncluded: false, hypothesisCount: hypotheses.length };
  }
