...
const { externalResearchEvidenceLadder } = require('./evidence-ladder');
...
async function researchWeb(input, options) {
  ...
  return { provider, query: qq, limit: nn, maxSnippet: ss, sources, summary, summaryStatus, canonicalWrite: false, evidenceStatus: 'external_unverified', evidenceLadder: externalResearchEvidenceLadder() };
}
...
module.exports = { researchWeb, summarizeSources, PROVIDERS, WebResearchError, MAX_BODY_BYTES, TOTAL_TIMEOUT_MS, DEFAULT_SNIPPET, MIN_SNIPPET, MAX_SNIPPET };
