...
const CLI_MUTATION_AUDIT_MAPPINGS = Object.freeze([
  ...
  ['hypotheses', 'candidate_claim', 'UPDATE', 'allow', true, 'cli_hypothesis_proposal'],
  ['hypotheses-tuning-apply', 'hypothesis_thresholds', 'UPDATE', 'allow', true, 'cli_hypothesis_threshold_apply'],
]);
