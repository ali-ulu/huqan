...
function buildMemoryAdmissionReceipt(decision = {}, opts = {}) {
  ...
  if (typeof declared === 'number' && Number.isFinite(declared)) {
    metadata.declaredConfidence = declared;
  }
  // Same additive rule for the declared shelf life: the read side can only
  // honour an expiry that survived onto the receipt.
