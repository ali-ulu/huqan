...
const EXPECTED_SUFFIXES = Object.freeze([
  ...
  'OBSERVABILITY_AUTHZ_POLICY', 'OBSERVABILITY_RATE_LIMIT_POLICY',
  'OBSERVABILITY_RETENTION_POLICY', 'OBSERVABILITY_WEBHOOK_POLICY',
  'PARANOID',
  'PLUGIN_PRODUCTION_ENFORCEMENT', 'PLUGIN_SIGNING_KEY',
  'PLUGIN_STRICT', 'SUPPLY_CHAIN_ACTIVATION_POLICY', 'PORT', 'RUST_BIN', 'TRUST_POLICY_ROOTS', 'TRUST_PROXY',
