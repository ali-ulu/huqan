...
const EXPECTED_SUFFIXES = Object.freeze([
  ...
  'EXTERNAL_CLIENT_ENDPOINT_ENABLED', 'HOST', 'HUMAN_APPROVAL_DISABLED',
  'INGEST_APPROVAL_LEASE_MS', 'KERNEL_VERSION', 'LANG', 'MEMORY_PATH',
...
test('environment compatibility inventory is the source-backed 25-suffix surface', () => {
