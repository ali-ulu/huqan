 ...
 * default outside production and only escalates when the deployment opts in via
 * `requireIdentityCard` (or `HUQAN_EXTERNAL_GUARD_REQUIRE_IDENTITY`), so
 * production always requires a signed card bound to a registered human sponsor.
 */
