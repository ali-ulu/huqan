...
const CATEGORY_ALIASES = Object.freeze({
  ...
  // No DESCRIPTIVE alias: it was a misspelling of DESTRUCTIVE that mapped a
  // benign "describe this" action onto PRODUCTION_MUTATION -> CRITICAL -> BLOCK
  // (#377). Unmapped tokens fall through to UNKNOWN_ACTION_CATEGORY, which is
  // still fail-closed (HUMAN_REVIEW) rather than silently allowed.
