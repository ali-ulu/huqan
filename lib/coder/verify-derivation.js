...
// Same normalization as the record's own digest -- see digestOrAbsent() in
// derivation-record.js for why line endings are not part of the claim.
function digestOrAbsent(content) {
  if (typeof content !== 'string') return ABSENT;
