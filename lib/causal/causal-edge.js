...
function validateCausalEdge(input) {
  ...
  if (Object.prototype.hasOwnProperty.call(input, 'id') && !isNonEmptyString(input.id)) {
    errors.push({
      code: CAUSAL_EDGE_ERROR_CODES.INVALID_ID,
  ...
  for (const field of ['from', 'to']) {
    if (Object.prototype.hasOwnProperty.call(input, field) && !isNonEmptyString(input[field])) {
      errors.push({
        code: CAUSAL_EDGE_ERROR_CODES.INVALID_ENDPOINT,
  ...
  if (Object.prototype.hasOwnProperty.call(input, 'confidence')) {
    if (typeof input.confidence !== 'number' || !Number.isFinite(input.confidence)) {
      errors.push({
        code: CAUSAL_EDGE_ERROR_CODES.INVALID_CONFIDENCE,
