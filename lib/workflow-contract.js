...
const WORKFLOW_CAPABILITIES = Object.freeze([
  ...
  workflow({ workflowId: 'approvals', route: '/api/v2/approvals', method: 'GET', mcpTool: 'huqan.approvals', availability: { cli: true } }),
  workflow({ workflowId: 'approval-decision', route: '/api/v2/approvals/{id}/decision', method: 'POST', mcpTool: 'huqan.approve', mutation: true, approvalRequired: true, availability: { cli: true } }),
