...
const CLI_COMMAND_CAPABILITIES = Object.freeze([
  ...
  ['hypotheses', 'hypotheses', 'hypotheses [--json] [--propose] [--critical N] | hypotheses review <candidateId> --accept|--reject', 'inspect deterministic graph hypotheses and record review verdicts', ['hipotezler']],
