...
const CLI_COMMAND_CAPABILITIES = Object.freeze([
  ...
  ['hypotheses', 'hypotheses', 'hypotheses [--json] [--propose] [--critical N] | hypotheses review <candidateId> --accept|--reject | hypotheses feedback | hypotheses tuning | hypotheses fitness', 'inspect deterministic graph hypotheses, record review verdicts, report per-rule feedback and threshold advice, and score graph health', ['hipotezler']],
