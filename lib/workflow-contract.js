...
const CLI_COMMAND_CAPABILITIES = Object.freeze([
  ...
  ['hypotheses', 'hypotheses', 'hypotheses [--json] [--propose] [--critical N] | hypotheses review <candidateId> --accept|--reject | hypotheses feedback', 'inspect deterministic graph hypotheses, record review verdicts, and report per-rule feedback', ['hipotezler']],
