const { containsWholeTerm, normalizeText } = require('./text-utils');
...
const NETWORK_MUTATION_HINTS = Object.freeze([
  ...
  'put',
  'patch',
  // 'delete' is already handled by DESTRUCTIVE_ACTIONS before this branch.
  // Keeping it here only creates an equivalent mutation surface.
  'webhook',
  'api write',
  'external api write',
  'remote update',
