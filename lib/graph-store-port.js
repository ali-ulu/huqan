...
/**
 * Bind Graph's existing persistence behavior behind one explicit store port.
 * Backend choice and all durable formats remain owned by the existing JSON
 * and SQLite implementations; this object only defines their shared boundary.
 */
...
module.exports = { createGraphStorePort };
