...
const MCP_TOOL_CLASSIFICATIONS = Object.freeze({
  ...
  // so it classifies exactly like huqan.learn (mutating write + review + AB4).
  'huqan.fractal-learn': Object.freeze({ mutating: true, category: 'write', alphaDecision: 'review', gates: ['AB1', 'AB2', 'AB4', 'AB11'] }),
