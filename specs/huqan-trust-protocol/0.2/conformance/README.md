# HUQAN Trust Protocol 0.2 Conformance

This publication reuses the frozen ATP 0.1 bundle algorithm and fixtures. The
verifier is published at the canonical HTP path, while the bundle fixtures and
their legacy schema remain at the preserved ATP 0.1 paths linked below.
...
- schema: [`../../../axiom-trust-protocol/0.1/schemas/trust-receipt-bundle.schema.json`](../../../axiom-trust-protocol/0.1/schemas/trust-receipt-bundle.schema.json)
...
```bash
python3 specs/huqan-trust-protocol/0.2/conformance/verify_bundle.py specs/axiom-trust-protocol/0.1/examples/receipt-bundle.valid.json
```
