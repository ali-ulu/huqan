...
Audit first, suggest second. Self-healing may propose fixes and draft PRs, but it must not auto-merge or silently rewrite trust decisions.

## v0.9.2 Bug Bounty Mode

Bug bounty mode turns regressions into explicit, reviewable targets for local-first CLI and enterprise dashboard workflows.

## v0.10 Streaming Trust + GitHub App

Streaming Trust adds continuous trust signals, and the GitHub App becomes the primary external collaboration surface.
