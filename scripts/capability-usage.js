...
const EVIDENCE = Object.freeze({
  ...
  'web-research': { none: 'ordinary research calls are read-only; openCandidates may write pending candidate rows, so absence of rows cannot prove the capability was never used' },
