...
describe('RFC-001 MCP tool name table', () => {
  it('defines twenty canonical names and twenty legacy aliases', () => {
    assert.equal(CANONICAL_MCP_TOOL_NAMES.length, 20);
    assert.equal(LEGACY_MCP_TOOL_NAMES.length, 20);
