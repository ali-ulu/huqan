...
describe('RFC-001 MCP tool name table', () => {
  it('defines twenty-one canonical names and twenty-one legacy aliases', () => {
    assert.equal(CANONICAL_MCP_TOOL_NAMES.length, 21);
    assert.equal(LEGACY_MCP_TOOL_NAMES.length, 21);
