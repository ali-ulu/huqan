...
describe('RFC-001 MCP tool name table', () => {
  it('defines sixteen canonical names and sixteen legacy aliases', () => {
    assert.equal(CANONICAL_MCP_TOOL_NAMES.length, 16);
    assert.equal(LEGACY_MCP_TOOL_NAMES.length, 16);
