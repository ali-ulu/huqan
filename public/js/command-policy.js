...
(() => {
  ...
  const labels = {
    ...
    scope: () => T('commandPolicy.scope','Shared scope: this file affects every hook configured to read the same policy file. The workspace selected in Settings does not isolate these rules.'),
    ...
    confirm: () => T('commandPolicy.confirm','I approve this change for every hook using this shared policy file.'),
